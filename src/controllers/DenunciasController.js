...
module.exports = {       
    ...
    async denContato (request, response) {
        ...
        .orderBy('denData')
        .select(['denuncias.denId', 'denuncias.denDescricao', 'denuncias.denData', 'denuncias.denTipo', 'denuncias.denSubId', 'contatos.conNomCompleto', 'tipdenuncias.tdeDescricao', 'subTipDenuncias.stdDescricao']);
